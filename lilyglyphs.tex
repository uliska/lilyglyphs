...
Implementation of rest glyphs has only begun.
Rests are usually available in starred and unstarred versions.
Please note that the dotted versions don't have the optional argument implemented yet -- this means you can only use them \enquote{as-is}.

\begin{reftable}{Rests}{rests}
\halfNoteRestUp & \cmd{halfNoteRestUp} & Half note Rest\\
\halfNoteRestUpDotted & \cmd{halfNoteRestUpDotted} & Dotted half note Rest\\
