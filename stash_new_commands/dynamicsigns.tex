...
\decrescHairpin & \cmd{decrescHairpin} & description\\
\crescHairpin & \cmd{crescHairpin} & description\\
\end{reftable}
...
\noindent\textbf{\textsf{Continuous text for} \cmd{decrescHairpin}:}\\
...
\noindent\textbf{\textsf{Continuous text for} \cmd{crescHairpin}:}\\
Lorem ipsum dolor sit amet, consectetur adipisicing elit,
