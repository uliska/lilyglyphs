...
Accidentals like \flat{} or \sharp, but also articulation scripts (\hspace{.75ex}\fermata{}) and time signatures such as \lilyTimeCHalf{} or \lilyTimeSignature{5\,+\,7}{8} are readily available.
...
One thing that sets \lilyglyphs{} apart from other solutions I had investigated is that one isn't restricted to a set of predefined symbols but can print \emph{any notation} that can be realized with LilyPond. 
...
in particular.
But if the above examples whet your appetite and match your professional needs you should really consider giving it a serious try -- it's all free anyway.
