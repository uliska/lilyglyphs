...
\begin{abstract}
\lilyglyphs is a \LaTeX{} package that allows to include notational elements from the exceptional LilyPond notation software as standard elements in the continuous text of \hologo{XeLaTeX} or  \hologo{LuaLaTeX}documents.
