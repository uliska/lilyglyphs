...
Place the lilyglyphs directory somewhere in your \texttt{texmf} tree and refer to the documentation of your \LaTeX{} distribution if there is anything unclear with manually installing packages.
...
You simply pass it the (absolute or relative) filename of the input file as its first and single parameter.
