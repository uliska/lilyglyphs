...
The Python script that processes your input file is \texttt{lily-glyph-commands.py}, located in the \dir{/scripts} subdirectory of the package.
...
Creating commands with images generated by LilyPond is a significantly more complex task than simply inserting Emmentaler glyphs, and therefore the Python script \texttt{lily-image-commands.py}, located in the \texttt{/scripts} directory, is a more complex one.
...
If you have prepared your input file you can run the \texttt{/scripts/lily-image-commands.py} script, passing it the complete file name (as a relative or absolute path) of your definitions file.
...
In that case you can run the script \texttt{lily-glyph-commands.py.py}, which is also located in the \texttt{/scripts} directory.
