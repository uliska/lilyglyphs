...
\begin{itemize}
	...
	Please refer to \fref{subsec:generic_access_commands} for more information.
	...
	As described in \fref{subsubsec:BGI_preparing_input} the value is kept until the end of the file is reached or the value is set newly.
\end{itemize}
...
The program parses the input file and creates a new file \texttt{/stash\_new\_commands/emmentaler/newGlyphCommands.tex} that is exactly like the one created by \texttt{buildglyphimages.py} (see \fref{subsubsec:BGI_utilizing_results}).
