...
\lilyglyphs is a package that allows to include notational elements from the exceptional LilyPond notation software as standard elements in the continuous text of \XeLaTeX{} documents.
