...
If you have prepared your input file you can run the \texttt{/py/buildglyphimages.py} script, passing it the complete file name (as a relative or absolute path) of your definitions file.
