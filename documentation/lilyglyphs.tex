...
\fancyExample & \cmd{fancyExample} & a fancy command using a LilyPond file\\
\end{reftable}
...
A good choice for example would be \dir{\textasciitilde/texmf/tex/latex/lilyglyphs\_private}.
